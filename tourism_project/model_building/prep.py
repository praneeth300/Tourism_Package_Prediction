...
DATASET_PATH = "hf://datasets/praneeth232/tourism/tourism.csv"
...
numeric_features = [
    ...
    'NumberOfChildrenVisited', # Number of children who visited with the customer
